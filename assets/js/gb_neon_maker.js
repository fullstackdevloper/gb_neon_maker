...
/*            if(neonConfigurations.dynamicLength > lengthLimit){
        ...
        changeColor: function(elem, fontColor) {
            ...
            if(onoffswitch == true) {
                ...
                if(fontColor == "#DC78FF" || fontColor == "#EF2CB8" || fontColor == "#ED9A9A" || fontColor == "#2B41E7" || fontColor == "#FF2828" || fontColor == "#FF7E55" || fontColor == "#FFF739" || fontColor == "#FFF1DC" || fontColor == "#EAEAEA" || fontColor == "#82F925"){
        ...
        handleStripeResponse:function(status, response){
            if (response.error) {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        $('#stripe input.button').css('display', 'none');
                        $('.gb_loading').css('display', 'block');
                    },
                    ...
                    complete: function() {
                        $('#stripe input.button').css('display', 'block');

                       // $('.gb_loading').css('display', 'none');
                    }
                });
        ...
        inquiryFormSubmit: function (elem) {
            ...
            $.post(ajaxurl, formdata, function (data) {
                if (data.status == 'success') {
                    $('.gb_sucess_msg').text("Thanks for submitting your information! We'll get back to you within 24-48 hours.");
