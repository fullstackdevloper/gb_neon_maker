<div class="sbt_text_font">
    <div class="gb_backing_type">
        <label><?php _e("Choose a Backing Type", "gb_neon_maker"); ?></label>
            ...
            <a onclick="GbNeonmaker.changeBackingType(this,'Stand');" href="javascript:void(0);"><li class="option-1"><span>Stand </span><span class="gb_text_info">Will incur an additional fee.</span></li></a>
        </ul>
    </div>
</div>
<div class="sbt_text_font">
