...
<div class="sbt_hint">
    ...
    <p>
        <?php print apply_filters('gb_color_hint', __("View actual <a href='https://glowbabyglow.com.au/colour-chart' target='_blank'>colour chart here</a>. Some colours have a white jacket when turned off and others have a coloured jacket.</br></br>If you’d like multiple neon colours, click ‘It’s not quite right’ and let us know more.", "gb_neon_maker")); ?>
    </p>
</div>